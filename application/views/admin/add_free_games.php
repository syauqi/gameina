            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1>Gameina - Add Free Game Data </h1>
                    </div>
                    <div class="col-md-12 bg-white p-4"
                        style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px">

                        <form method="post" enctype="multipart/form-data"
                            action="<?=base_url('gamedata/add_free_games')?>">
                            ...
                            <div class="form-group">
                                <label for="inputAddress">Deskripsi Game</label>
                                <input required type="text" class="form-control" id="deskripsi_game"
                                    name="deskripsi_game">
                            </div>
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    <div class="input-group mt-4">
                                        <div class="custom-file">
                                            ...
                                            <input required type="file" name="link_game" class="custom-file-input"
                                                id="inputGroupFile01" aria-describedby="inputGroupFileAddon01">
                                            <label class="custom-file-label" for="inputGroupFile01">Upload HTML</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
