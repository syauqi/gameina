                    ...
                    <div class="row container">
                        <div class="col-md-7 bg-white p-3"
                            ...
                            <p style="font-weight:500px!important;font-size:18px;text-align:justify;" class="">Game
                                ...
                                <br>Deskripsi Game :
                                <?=$detail->deskripsi_game?><br>Kategori : <?=$detail->kategori?><br>Link Game :
                                <?=$detail->link_game?><br>



                                <a href="<?=base_url('admin/free_games')?>"
                                    class="btn btn-danger btn-block mt-4">Kembali</a>
                        </div>

                        <div class="col-md-4 bg-white p-3 ml-3"
                            style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px;">
                            <img src="<?=base_url() . 'assets/img/' . $detail->gambar_game;?>"
