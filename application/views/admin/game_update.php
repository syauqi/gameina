            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1>Game Management - Game Update </h1>
                    </div>
                    <div class="row container">
                        <div class="col-md-7 bg-white p-3"
                            style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px;">
                            <h3 class="font-weight-bold" style="color: #34395e!important">Game Data Update</h3>
                            <hr>
                            <?php foreach ($game as $u) {?>

                            <form action="<?=base_url('admin/game_edit')?>" enctype="multipart/form-data" method="post">
                                <div class="form-group">
                                    <input type="hidden" name="id" value="<?=$u->id_game?>">
                                    <label for="exampleInputEmail1" class="font-weight-bold"
                                        style="font-size: 17px;">Nama game</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" required name="nama_game"
                                        value="<?=$u->nama_game?>">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1" class="font-weight-bold"
                                        style="font-size: 17px;">ID Publisher</label>
                                    <input type="number" class="form-control" name="id_publisher"
                                        value="<?=$u->id_publisher?>" id="exampleInputPassword1">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1" class="font-weight-bold"
                                        style="font-size: 17px;">Nama Publisher</label>
                                    <input type="text" class="form-control" name="nama_publisher"
                                        value="<?=$u->nama_publisher?>" id="exampleInputPassword1">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1" class="font-weight-bold"
                                        style="font-size: 17px;">Deskripsi Produk</label>
                                    <input type="text" class="form-control" name="deskripsi_produk"
                                        value="<?=$u->deskripsi_produk?>" id="exampleInputPassword1">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1" class="font-weight-bold"
                                        style="font-size: 17px;">Kategori</label>
                                    <input type="text" class="form-control" name="kategori" value="<?=$u->kategori?>"
                                        id="exampleInputPassword1">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1" class="font-weight-bold"
                                        style="font-size: 17px;">Harga</label>
                                    <input type="number" class="form-control" name="harga" value="<?=$u->harga?>"
                                        id="exampleInputPassword1">
                                </div>
                        ...
                        <div class="col-md-4 bg-white p-3 ml-3"
                            style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px;">
                            <img src="<?=base_url() . 'assets/games_picture/' . $u->gambar_game;?>"
