            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1>User Management - User Update </h1>
                    </div>
                    <div class="row container">
                        <div class="col-md-7 bg-white p-3"
                            style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px;">
                            <h3 class="font-weight-bold" style="color: #34395e!important">User Data Update</h3>
                            <hr>
                            <?php foreach ($publisher as $u) {?>

                            <form action="<?=base_url('admin/publisher_edit')?>" enctype="multipart/form-data"
                                method="post">
                                <div class="form-group">
                                    <input type="hidden" name="id" value="<?=$u->id_publisher?>">
                                    ...
                                    <input type=" text" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" required name="nama"
                                        value="<?=$u->nama_publisher?>">
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" readonly name="email"
                                        value="<?=$u->email_publisher?>" id="exampleInputPassword1">
                                </div>
