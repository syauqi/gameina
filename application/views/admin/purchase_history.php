            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1>Gameina - Purchase History </h1>
                    </div>
    ...
    ?>
                                        <tr class="text-center">
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="<?php echo site_url('admin/purchase_delete/' . $u->id_pembayaran); ?>"
...
?>
    ...
    <?php if ($this->session->flashdata('purchase-delete')): ?>
    <script>
    Swal.fire({
        icon: 'success',
