            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1>Gameina - Free Games Data </h1>
                    </div>
                    <div class="section-header">
                        <a href="<?=base_url('admin/add_free_games')?>" class="btn btn-primary">Tambah Data Free
                            Game</a>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
...
foreach ($user as $u) {
    ?>
                                        <tr>
                                            ...
                                            <th scope="row">
                                                <?php echo $u->nama_game ?>
                                            </th>
                                            <td>
                                                <img height="30px"
                                                    src="<?=base_url() . 'assets/img/' . $u->gambar_game;?>">
                                            </td>
                                            ...
                                            <td>
                                                <?php echo $u->link_game ?>
                                            </td>


                                            <td class="text-center">

                                                <a href="<?php echo site_url('admin/free_games_detail/' . $u->id_game); ?>"
                                                    class="btn btn-success">Detail</a>
                                            </td>
                                            <td class="text-center">

                                                <a href="<?php echo site_url('admin/free_games_update/' . $u->id_game); ?>"
                                                    class="btn btn-info">Update</a>

                                                <a href="<?php echo site_url('admin/free_games_delete/' . $u->id_game); ?>"
...
?>
    ...
    <?php if ($this->session->flashdata('game-delete')): ?>
    <script>
    Swal.fire({
        icon: 'success',
        title: 'Data Game Telah Dihapus!',
    ...
    Swal.fire({
        icon: 'success',
        title: 'Data Game Telah Ditambahkan!',
