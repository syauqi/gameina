                ...
                <section class="section">
                    ...
                    <div class="row container">
                        <div class="col-md-7 bg-white p-3"
                            ...
                            <h3 class="font-weight-bold" style="color: #34395e!important">User Detail</h3>
                            <hr>
                            <p style="font-weight:500px!important;font-size:18px;text-align:justify;" class="">User - ID
                                :
                                <?=$detail->id?>
                                <br>Nama : <?=$detail->nama?>
                                <br>Email :
                                <?=$detail->email?><br>Password : Encrypted<br>Is Active :
                                <?=$detail->is_active?><br>Date Created :
                                <?=$detail->date_created?><br>
                                inacash : <?='Rp ' . $detail->inacash?></p>



                            <a href="<?=base_url('admin/user_data')?>" class="btn btn-danger btn-block">Kembali</a>
                        </div>
