            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1>Gameina - Game Data </h1>
                    </div>
                    <div class="section-header">
                        <a href="<?=base_url('admin/add_game')?>" class="btn btn-primary">Tambah Data Store
                            Game</a>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
...
foreach ($user as $u) {
    ?>
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                <img height="30px"
                                                    src="<?=base_url() . 'assets/games_picture/' . $u->gambar_game;?>">
                                            </td>

                                            <td class="text-center">

                                                <a href="<?php echo site_url('admin/game_detail/' . $u->id_game); ?>"
                                                    class="btn btn-success">Detail</a>
                                            </td>

                                            <td class="text-center">

                                                <a href="<?php echo site_url('admin/game_update/' . $u->id_game); ?>"
                                                    class="btn btn-info">Update</a>

                                                <a href="<?php echo site_url('admin/game_delete/' . $u->id_game); ?>"
