            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1>Game Management - Free Play Game Update </h1>
                    </div>
                    <div class="row container">
                        <div class="col-md-7 bg-white p-3"
                            style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px;">
                            <h3 class="font-weight-bold" style="color: #34395e!important">Free Play Game Data Update
                            </h3>
                            <hr>
                            <?php foreach ($game as $u) {?>

                            <form action="<?=base_url('admin/free_games_edit')?>" enctype="multipart/form-data"
                                method="post">
                                <div class="form-group">
                                    <input type="hidden" name="id_games" value="<?=$u->id_game?>">
                                    <label for="exampleInputEmail1" class="font-weight-bold"
                                        style="font-size: 17px;">Nama game</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" required name="nama_games"
                                        value="<?=$u->nama_game?>">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1" class="font-weight-bold"
                                        style="font-size: 17px;">Deskripsi Game</label>
                                    <input type="text" class="form-control" name="deskripsi_games"
                                        value="<?=$u->deskripsi_game?>" id="exampleInputPassword1">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1" class="font-weight-bold"
                                ...
                                <!-- <div class="form-group">
                                    <label for="exampleInputPassword1" class="font-weight-bold"
                                        style="font-size: 17px;">Link Game</label>
