            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1>Game Management - Game Detail </h1>
                    </div>
                    <div class="row container">
                        <div class="col-md-7 bg-white p-3"
                            style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px;">
                            <h3 class="font-weight-bold" style="color: #34395e!important">Game Detail</h3>
                            <hr>
                            <p style="font-weight:500px!important;font-size:18px;text-align:justify;" class="">Game
                                - ID
                                :
                                <?=$detail->id_game?>
                                <br>Nama Game : <?=$detail->nama_game?>
                                <br>Nama Publisher :
                                <?=$detail->nama_publisher?><br>Kategori : <?=$detail->kategori?><br>Harga :
                                <?=$detail->harga?><br>Deskripsi Produk :
                                <?=$detail->deskripsi_produk?></p>



                            <a href="<?=base_url('admin/game_data')?>" class="btn btn-danger btn-block">Kembali</a>
                        </div>

                        <div class="col-md-4 bg-white p-3 ml-3"
                            style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px;">
                            <img src="<?=base_url() . 'assets/games_picture/' . $detail->gambar_game;?>"
