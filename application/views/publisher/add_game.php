            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand text-danger">
                        <a href="<?= base_url('publisher') ?>" style="font-size: 24px; font-weight:700" class="text-danger">Gameindonesia</a>
                    </div>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="<?= base_url('publisher/game_data') ?>">Data Game</a></li>
                            </ul>
                        </li>
            ...
            <div class="main-content">
                <section class="section">
                    ...
                    <div class="col-md-12 bg-white p-4" style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px">
                        ...
                        <form method="post" enctype="multipart/form-data" action="<?= base_url('gamedata/add_game_publisher') ?>">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input required type="text" onkeyup="autofill()" name="id_publisher" list="idpublisher" class="form-control" id="id_publisher">
                            ...
                            <div class="form-group">
                                ...
                                <input required type="text" readonly class="form-control" id="nama_publisher" name="nama_publisher">
                            </div>
                            <div class="form-group">
                                <label for="inputAddress2">Deskripsi Produk</label>
                                <input required type="text" class="form-control" name="deskripsi_produk" id="inputAddress2">
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
