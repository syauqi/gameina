        ...
        <div class="col-md-12">
            <div class="jumbotron jumbotron-fluid aksi-jumbotron rellax">
                <div class="container " data-aos="fade-right" data-aos-duration="1500">
                    <h1 class="display-4 font-weight-bold header-jumbotron">Kategori Aksi</h1>
                    <p class="lead text-jumbotron">Mainkan game bergenre Aksi dan jadilah yang terkuat! <br> mainkan di page
