...
<body>
    <div class="row">
        <div class="col-md-12">
            <div class="jumbotron jumbotron-fluid  fps-jumbotron rellax">
                <div class="container " data-aos="fade-right" data-aos-duration="1500">
                    <h1 class="display-4 font-weight-bold text-white">Kategori FPS</h1>
                    <p class="lead text-jumbotron">Mainkan game bergenre FPS atau <i>first action shooter</i> di page
                        ini! <br> dan rasakan ketegangan keseruannya!</p>
                </div>
            </div>
        </div>
    </div>
