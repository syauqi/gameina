...
<body>
    <div class="row">
        <div class="col-md-12">
            <div class="jumbotron jumbotron-fluid multi-jumbotron rellax">
                <div class="container " data-aos="fade-right" data-aos-duration="1500">
                    <h1 class="display-4 font-weight-bold header-jumbotron">Kategori Multiplayer</h1>
                    <p class="lead text-jumbotron">Mainkan game bergenre Multiplayer bersama temanmu!<br> mainkan di
                        page
