                                        ...
                                        <div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--left">
                                            <ul class="kt-menu__subnav">
                                                <li class="kt-menu__item kt-menu__item--active " aria-haspopup="true"><a
                                                        href="<?=base_url('user')?>" class="kt-menu__link "><i
                                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                                                            class="kt-menu__link-text">Halaman Utama</span></a></li>
                                                <li class="kt-menu__item  " aria-haspopup="true">
                                                    <a href="dashboards_fluid.html" class="kt-menu__link "><i
                                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                                                            class="kt-menu__link-text">Rekomendasi</span></a></li>
                                            </ul>
                                        </div>
                                    </li>
                                        ...
                                        <div class="kt-mycart__body kt-scroll" data-scroll="true" data-height="245"
                                            ...
                                            <div class="kt-mycart__item">
                                                <div class="kt-mycart__container">
                                                    ...
                                                    <a href="#" class="kt-mycart__pic">
                                                        <img src="<?=base_url('assets/')?>assets/media/products/product9.jpg"
                                                            title="">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="kt-mycart__item">
                                                <div class="kt-mycart__container">
                                                    ...
                                                    <a href="#" class="kt-mycart__pic">
                                                        <img src="<?=base_url('assets/')?>assets/media/products/product13.jpg"
                                                            title="">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="kt-mycart__item">
                                                <div class="kt-mycart__container">
                                                    ...
                                                    <a href="#" class="kt-mycart__pic">
                                                        <img src="<?=base_url('assets/')?>assets/media/products/product16.jpg"
                                                            title="">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="kt-mycart__item">
                                                <div class="kt-mycart__container">
                                                    ...
                                                    <a href="#" class="kt-mycart__pic">
                                                        <img src="<?=base_url('assets/')?>assets/media/products/product15.jpg"
                                                            title="" alt="">
                                                    </a>
                                                </div>
                                            </div>
...
?>
            ...
            <body>
                <div class="row">
                    <div class="col-md-12">
                        <div class="jumbotron jumbotron-fluid aksi-jumbotron rellax">
                            <div class="container " data-aos="fade-right" data-aos-duration="1500">
                                <h1 class="display-4 font-weight-bold header-jumbotron">Dreadout</h1>
                                <p class="lead text-jumbotron">Horror & Menegangkan</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <a class="btn btn-danger" href="<?=base_url('user/bayar')?>">bayar</a>
                    </div>
                </div>
